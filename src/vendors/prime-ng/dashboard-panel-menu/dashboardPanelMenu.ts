...
export class DashboardBasePanelMenuItem {
...
@Component({
    selector: 'p-dashboardPanelMenuSub',
    template: `
        <ul class="ui-menu-list ui-helper-reset" [style.display]="expanded ? 'block' : 'none'">
            <li *ngFor="let child of item.items" class="ui-menuitem ui-corner-all" [ngClass]="{'ui-menu-parent':child.items}">
                ...
                <p-dashboardPanelMenuSub [item]="child" [expanded]="child.expanded" *ngIf="child.items"></p-dashboardPanelMenuSub>
            </li>
        </ul>
    `
})
export class DashboardPanelMenuSub extends DashboardBasePanelMenuItem {
            ...
            <div *ngFor="let item of model;let f=first;let l=last;" class="ui-panelmenu-panel">
                ...
                <div *ngIf="item.items" class="ui-panelmenu-content-wrapper" [@rootItem]="item.expanded ? 'visible' : 'hidden'" 
                    ...
                    <div class="ui-panelmenu-content ui-widget-content">
                        <p-dashboardPanelMenuSub [item]="item" [expanded]="true"></p-dashboardPanelMenuSub>
                    </div>
                </div>
            </div>
        </div>
...
export class DashboardPanelMenu extends DashboardBasePanelMenuItem {
...
@NgModule({
    ...
    exports: [DashboardPanelMenu,RouterModule],
    declarations: [DashboardPanelMenu,DashboardPanelMenuSub]
})
export class DashboardPanelMenuModule { }

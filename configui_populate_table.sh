...
(2,'WS backend','WS','HttpCallout','WS','Java'),
...
(16,'http backend for dot net','HTTP','HttpCallout','HTTP','Dot Net'),
(17,'SQL backend for dot net','SQL','SQLCallout','SQL','Dot Net'),
(18,'async call for dot net','ASYNC_CALL','AsycCALL','ASYNC_CALL','Dot Net');
...
(30,'MEM CACHE end point','net.rubyeye.xmemcached.XMemcachedClient.delete0(Ljava/lang/String;IJZJ);','Mem Cache delete',6,false,'-','Java'),
...
(4,'NDC_CONTINUE_ON_CONTROL_CONNECTION_ERROR','','','0','0'),
